...
const BoxShadowComponent = props => {
  ...
  const handleChange = (id, newValue) => {
    /* eslint-disable */console.log(...oo_oo(`149243884_23_8_23_31_4`, newValue));
    let updatedValue = {
      ...value,
      [id]: newValue
    };
...
const IconCollection = props => {
  ...
  const handleItemClick = index => {
    /* eslint-disable */console.log(...oo_oo(`2421838248_199_8_199_45_4`, filteredIcons[index]));
...
controlConstructor['box-shadow'] = Control.extend({
  ready: function () {
    ...
    const renderBoxShadow = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_box_shadow__WEBPACK_IMPORTED_MODULE_0__.BoxShadowComponent, {
        ...props
      }));
    };
...
controlConstructor['radio-image'] = Control.extend({
  ready: function () {
    ...
    const renderRadioImage = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_radio_image__WEBPACK_IMPORTED_MODULE_1__.RadioImageComponent, {
        ...props
      }));
    };
...
controlConstructor['section-tab'] = Control.extend({
  ready: function () {
    ...
    const renderSectionTab = instance => {
      ...
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_section_tab__WEBPACK_IMPORTED_MODULE_2__.SectionTabComponent, {
        ...props
      }));
    };
...
controlConstructor['icon-picker'] = Control.extend({
  ready: function () {
    ...
    const renderIconPicker = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_icon_picker__WEBPACK_IMPORTED_MODULE_3__.IconPickerComponent, {
        ...props
      }));
    };
...
controlConstructor['toggle-button'] = Control.extend({
  ready: function () {
    ...
    const renderToggleButton = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_toggle_button__WEBPACK_IMPORTED_MODULE_4__.ToggleButtonComponent, {
        ...props
      }));
    };
...
controlConstructor['radio-tab'] = Control.extend({
  ready: function () {
    ...
    const renderRadioTab = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(Example, {
        ...props
      }));
    };
...
controlConstructor['typography'] = Control.extend({
  ready: function () {
    ...
    const renderTypography = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_typography__WEBPACK_IMPORTED_MODULE_7__.TypographComponent, {
        ...props
      }));
    };
...
controlConstructor['ian-text'] = Control.extend({
  ready: function () {
    ...
    const renderText = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_text__WEBPACK_IMPORTED_MODULE_5__.TextComponent, {
        ...props
      }));
    };
...
controlConstructor['radio-tab'] = Control.extend({
  ready: function () {
    ...
    const renderRadioTab = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_radio_tab__WEBPACK_IMPORTED_MODULE_6__.RadioTabComponent, {
        ...props
      }));
    };
...
controlConstructor['ian-number'] = Control.extend({
  ready: function () {
    ...
    const renderNumber = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_number__WEBPACK_IMPORTED_MODULE_8__.NumberComponent, {
        ...props
      }));
    };
...
controlConstructor['border'] = Control.extend({
  ready: function () {
    ...
    const renderBorder = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_border__WEBPACK_IMPORTED_MODULE_9__.BorderComponent, {
        ...props
      }));
    };
...
controlConstructor['dimension'] = Control.extend({
  ready: function () {
    ...
    const renderDimension = () => {
      if (rendered) return;
      rendered = true;
      reactRoot.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_dimension__WEBPACK_IMPORTED_MODULE_10__.DimensionComponent, {
        ...props
      }));
    };
