    ...
    if( ! class_exists( __NAMESPACE__ . '\\Header_Middle_Row' ) ) {
        ...
        class Header_Middle_Row extends Section {
            ...
            public function register_controls() {
                ...
                $this->add_control( 'header_middle_row_middle_column_heading_toggle' );
                $this->add_control( 'header_middle_row_middle_column_width_behavior' );
            ...
            public function get_settings( $id = '' ): array {
                $settings = [
                    ...
                    'header_middle_row_middle_column_heading_toggle'    =>  [
                        'transport' =>  'postMessage',
                        'default'   =>  $this->get_defaults( $id )
                    ],
                    ...
                    'header_middle_row_middle_column_width_behavior'    =>  [
            ...
            public function get_controls( $id = '' ): array {
                $controls = [
                    ...
                    'header_middle_row_middle_column_heading_toggle' =>  array_merge( $this->common, [
                        'label' =>  esc_html__( 'Middle Column Settings', 'i-am-news' ),
                        'type'  =>  'heading-toggle'
                    ] ),
                    ...
                    'header_middle_row_middle_column_width_behavior' =>  array_merge( $this->common, [
            ...
            public function get_dynamic_css_args(): array {
                $dynamic_css_args = [
                    'header_middle_row_background' =>  [
                        'value' =>  $this->get_customizer_value( 'header_middle_row_background' ),
                        'selector'  =>  '.ian-header-middle-row',
                        'default'   =>  $this->get_defaults( 'header_middle_row_background' ),
                        'property'  =>  'background'
                    ],
                    'header_middle_row_border' =>  [
                        'value' =>  $this->get_customizer_value( 'header_middle_row_border' ),
                        'selector'  =>  '.ian-header-middle-row',
                        'default'   =>  $this->get_defaults( 'header_middle_row_border' )
                    ],
                    'header_middle_row_box_shadow' =>  [
                        'value' =>  $this->get_customizer_value( 'header_middle_row_box_shadow' ),
                        'selector'  =>  '.ian-header-middle-row',
                        'default'   =>  $this->get_defaults( 'header_middle_row_box_shadow' )
                    ],
                    'header_middle_row_padding'    =>  [
                        'value' =>  $this->get_customizer_value( 'header_middle_row_padding' ),
                        'selector'  =>  '.ian-header-middle-row',
